/*
  Simon for Circuit Playground

  Stitch & Stuff: Making Sewable Games
  Tuesday, November 26, 2019, 6:30pm - 9:00pm
  Dames Making Games + Social Body Lab
  SparkFun Inventor’s Kit
  Circuit 2C-Simon Says

  The Simon Says game flashes a pattern using LED lights, then the player must repeat the pattern.

  This sketch is a modification of the Simon Says game, which was written by SparkFun Electronics, with lots of help from the Arduino community.
  This code is completely free for any use.

  Original code is available here: https://github.com/sparkfun/SIK-Guide-Code/blob/master/SIK_Circuit_2C-SimonSays/SIK_Circuit_2C-SimonSays.ino
...
int numberOfPixels = 10;
Adafruit_NeoPixel strip = Adafruit_NeoPixel(numberOfPixels, neopixelPin, NEO_GRB + NEO_KHZ400);
...
int button[] = {A1, A3, A5, A7};  //red is button[0], yellow is button[1], green is button[2], blue is button[3]
...
int buzzerPin = 14;           //pin that the buzzer is connected to
